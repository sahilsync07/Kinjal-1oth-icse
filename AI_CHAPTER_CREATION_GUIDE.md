...
- `subjects/*/data.js`: Data files containing chapter metadata (one per subject folder).
...
Create a new HTML file for the chapter inside the subject folder (e.g., `subjects/eng_lang/tenses.html`). 
...
1. Create a new JS file for the chapter (or append to `app.js` if it's English Grammar). E.g., `subjects/eng_lang/tenses.js`.
...
1. Open the relevant subject data file in the `subjects/` directory (e.g., `subjects/eng_lang/data.js`).
